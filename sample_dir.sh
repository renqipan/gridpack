...
do
	...
	a3=${ghz1[i]}
	a4=${ghz4[i]}
	dir=tHW_H4l125_couplings${a1}${a2}${a3}${a4}
	rm -rf $dir
	mkdir  $dir
	cp -r thw_H4l125_JHUGen_couplings1020/* $dir
	cd $dir
...
ls | grep tHW_H4l > ../../dir_thw.txt
cd ../../
echo "the directory list is written into dir_thw.txt "
